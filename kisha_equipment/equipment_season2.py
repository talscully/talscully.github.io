...
equipment = np.array([
    ...
    ("Bottled Breath",0.5,1,"Basket, Medicine","","m",0,0,"This bottle contains a breath of elemental air. When you inhale it, you either exhale it or hold it.<br><br>If you exhale the breath, you gain the effect of the gust of wind spell. If you hold the breath, you don't need to breathe for 1 hour, though you can end this benefit early (for example, to speak). Ending it early doesn't give you the benefit of exhaling the breath."),
    ("Clothes, Traveller's",4,1,"Wearing","","",0,0,"These are simple traditional robes of the Mtawa. Holsters for two flasks and 10 darts, as well as other things (pouches, Shanga beads) may be tied to the belt."),
    ("Clothes, Traveller's (spare)",4,1,"Bag of Holding","","",0,0,"These are the traditional robes of the Mtawa. Holsters for two flasks and 10 darts, as well as other things (pouches, Shanga beads) may be tied to the belt."),
    ("Coin Pouch",1,1,"Bag of Holding","6","",0,0,"This cloth pouch can hold 1/5 cubic foot/6 pounds of gear."),
    ("Cook's Utensils",8,1,"Bag of Holding","","",0,0,"Cook's utensils include a metal pot, knives, forks, a stirring spoon, and a ladle. Proficiency with Cook's Utensils lets you add your proficiency bonus to any ability checks you make using these tools.<br><br><img src='images/cooks_utensils.png'/>"),
    ...
    ("Coins, Suns (Dwarven money)",.02,money[3],"Coin Pouch","","",0,0,""),
    ("Couscous (sack)",1,1,"Basket, Cooking","","",0,0,"This small sack holds 1 pound (3 cups) of couscous. Each cup of uncooked couscous expands about 2 cups when cooked."),
    ("Dart",0.25,10,"Belt","","",0,0,"Ranged attack: <b>1d4+4 piercing (20 ft/60 ft)</b><br><br>Proficiency with a dart allows you to add your proficiency bonus to the attack roll for any attack you make with it. Ten darts fit in small holsters in my belt."),
    ("Dart (spare)",0.25,16,"Bag of Holding","","",0,0,"Ranged attack: <b>1d4+4 piercing (20 ft/60 ft)</b><br><br>Proficiency with a dart allows you to add your proficiency bonus to the attack roll for any attack you make with it. Ten darts fit in small holsters in my belt."),
    ("Devastation Orb",0,1,"Bag of Holding","","",0,0,"Put into it by the giant skeleton ghosts."),
    ("DRAGON LADY's fancy sword",0,1,"Bag of Holding","","",0,0,"Picked up during battle."),
    ("Flask (empty)",1,5,"Basket, Medicine","","",0,0,"A flask can hold 1 pint of liquid."),
    ("Flour (sack)",5,1,"Basket, Cooking","","",0,0,"This 5 pound sack of flour can be used for cooking or invisibility detection."),
    ...
    ("Potion of Healing",0.5,1,"Belt","","m",0,0,"A character who drinks the magical red fluid in this vial regains 2d4 + 2 hit points. Drinking or administering a potion takes an action.<br><br><img src='images/potion_of_healing.png'/>"),
    ("Pouch of Rice?",1,1,"Basket, Cooking","","m",0,0,"This sack appears to be able to hold 1 pound of some sort of grain whether full or empty. You can use an action to open the pouch. The bag contains some sort of grain or powder as determined by rolling a d8 on the table below.<br><br>Once the pouch has been opened twice, it can't be used again until the next dawn.<br><table class='itemNotesTable'><tr><th style='padding-left:20px'>d8</th><th style='text-align:left; padding-left:20px; padding-right:20px'>Contents</th></tr><tr><td style='padding-left:20px'>1</td><td style='text-align:left; padding-left:20px; padding-right:20px'>Pepper explodes from the bag, having the same effects of <a target='_blank' href='https://www.dndbeyond.com/magic-items/dust-of-sneezing-and-choking'>Dust of Sneezing and Choking</a></td></tr><tr><td style='padding-left:20px'>2</td><td style='text-align:left; padding-left:20px; padding-right:20px'>1 pound (3 cups) of flour</td></tr><tr><td style='padding-left:20px'>3</td><td style='text-align:left; padding-left:20px; padding-right:20px'>1 pound (2 cups) of dried black beans</td></tr><tr><td style='padding-left:20px'>4</td><td style='text-align:left; padding-left:20px; padding-right:20px'>1 pound (2 cups) of sugar</td></tr><tr><td style='padding-left:20px'>5</td><td style='text-align:left; padding-left:20px; padding-right:20px'>1 pound (5 cups) of oats</td></tr><tr><td style='padding-left:20px'>6</td><td style='text-align:left; padding-left:20px; padding-right:20px'>1 pound (3 cups) of couscous</td></tr><tr><td style='padding-left:20px'>7</td><td style='text-align:left; padding-left:20px; padding-right:20px'>1 pound (2.5 cups) of jasmine rice</td></tr><tr><td style='padding-left:20px'>8</td><td style='text-align:left; padding-left:20px; padding-right:20px'><a target='_blank' href='https://www.dndbeyond.com/magic-items/dust-of-disappearance'>Dust of Disappearance</a> explodes from the bag</td></tr></table><br><img src='images/pouch_of_rice.png'/>"),
    ...
    ("Rations (1 day)",2,7,"Basket, Cooking","","",0,0,"Rations consist of dry foods suitable for extended travel, including jerky, dried fruit, hardtack, and nuts."),
    ("Red Scale Medal",0,1,"Bag of Holding","","",0,0,"Received in honor of saving Mayor Justic and Bakke at large from the Renegade's Rebels.<br><br><img src='images/red_scale.png'/>"),
    ("Rice (sack)",3,1,"Basket, Cooking","","",0,0,"This sack holds 3 pounds (7.5 cups) of jasmine rice. Each cup of uncooked jasmine rice expands about 3 cups when cooked."),
    ...
    ("Sack (empty)",0.5,3,"Basket, Cooking","","",0,0,"A sack is made from simple mesh cloth and can hold up to 5 pounds or 15 cups of dry solids."),
    ...
    ("Strongscale's Shield",0,1,"Bag of Holding","","",0,0,"Picked up during battle."),
    ("Tinderbox",1,1,"Bag of Holding","","",0,0,"This small container holds flint, fire steel, and tinder (usually dry cloth soaked in light oil) used to kindle a fire. Using it to light a torch -- or anything else with abundant, exposed fuel -- takes an action. Lighting any other fire takes 1 minute."),
    ("Vial (empty)",0.5,5,"Basket, Medicine","","",0,0,"A vial can hold 4 ounces of liquid."),
    ("Waterskin",5,1,"Bag of Holding","","",0,0,"A waterskin can hold 4 pints of liquid."),
    ("Wine (bottle)",3,1,"Basket, Cooking","","",0,0,"This ceramic bottle holds 1.5 pints of wine. The bottle has a protective holster."),
...
html.write('<p id="money"><b>Gold:</b> '+repr(money[0])+', <b>Silver:</b> '+repr(money[1])+', <b>Copper:</b> '+repr(money[2])+'<br><br><b>Suns (Dwarven money):</b> '+repr(money[3])+'</p>\n')
html.write('</div></div>\n\n')

# HTML table of inventory
html.write('<div id="inventory"><div><table><tr><th class="Name">Item</th><th class="Weight">Weight</th><th class="Quantity">Quantity</th><th class="Location">Location</th></tr></table>\n')
